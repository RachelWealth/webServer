...
public class AllPaymentSteps {
    ...
    public void a_customer_with_a_bank_account_with_balance(Integer int1) throws BankServiceException_Exception {
        customeraccountID=callBankAuthService.CreateOneAccount(new Customer("Misha","Arora","cprMisha", int1.doubleValue(), "customer"));
    ...
    public void that_the_customer_is_registered_with_dtu_pay() throws BankServiceException_Exception {
        generalController.regDtuPayUser(new Customer("Misha","Arora","cprMisha",customeraccountID,"customer"));
    ...
    public void a_merchant_with_a_bank_account_with_balance(Integer int1) throws BankServiceException_Exception {
        merchantaccountID=callBankAuthService.CreateOneAccount(new Customer("DTUManagement","CanteenService","cprDTUManagement",int1.doubleValue(),"merchant"));
    ...
    public void that_the_merchant_is_registered_with_dtu_pay() throws BankServiceException_Exception {
        generalController.regDtuPayUser(new Customer("DTUManagement","CanteenService","cprDTUManagement",merchantaccountID,"merchant"));
    ...
    public void the_merchant_initiates_a_payment_for_kr_by_the_customer(Integer int1) {
        generalController.addNewTrades(new Trade(customeraccountID,1000.0, merchantaccountID,2000.0,int1.doubleValue()));
    }
    ...
    public void the_balance_of_the_customer_at_the_bank_is_kr(Integer int1) throws BankServiceException_Exception {
        double currentBalance=callBankAuthService.checkBalance(customeraccountID).doubleValue();
        assertEquals(currentBalance,int1.doubleValue());
    }
    @Then("the balance of the merchant at the bank is {int} kr")
    public void the_balance_of_the_merchant_at_the_bank_is_kr(Integer int1) throws BankServiceException_Exception {
        double currentBalance=callBankAuthService.checkBalance(merchantaccountID).doubleValue();
        assertEquals(currentBalance,int1.doubleValue());
    }
}
